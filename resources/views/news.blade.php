    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="single_blog_post_box">
                    <div class="blog_post_photo">
                        <img src="img/latest_news_post_2.jpg" alt="">
                        <div class="blog_post_date_caption">
                            <span>08 Apr</span>
                        </div>
                    </div>
                    <div class="blog_post_txt">
                        <div class="blog_post_heading">
                            <h2><a href="single-post.html">A shadowy flight into the dangerous world of a man who does not exist</a></h2>
                            <p>Posted By : Admin</p>
                        </div>
                        <div class="blog_post_content">
                            <p>Doin' it our way. Nothin's gonna turn us back now. Straight ahead and on the track now. We're gonna make our dreams come true. Just two good ol' boys Wouldn't change if they could. Fightin' the system like a true modern day Robin Hood. Doin' it our way. Nothin's gonna turn us back now. Straight ahead and on the track now. We're gonna make our dreams come true. </p>
                            <ul>
                ...
                <div class="single_blog_post_box">
                    <div class="blog_post_photo">
                        <img src="img/latest_news_post_3.jpg" alt="">
                        <div class="blog_post_date_caption">
                            <span>08 Apr</span>
                        </div>
                    </div>
                    <div class="blog_post_txt">
                        <div class="blog_post_heading">
                            <h2><a href="single-post.html">Its like a kind of torture to have to watch the show</a></h2>
                            <p>Posted By : Admin</p>
                        </div>
                        <div class="blog_post_content">
                            <p> It's time to play the music. It's time to light the lights. It's time to meet the Muppets on the Muppet Show tonight? Wouldn't you like to get away. Sometimes you want to go where everybody knows your name. And they're always glad you came. Now were up in the big leagues getting' our turn at bat. They're creepy and they're kooky mysterious and spooky.</p>
                            <ul>
                ...
                <div class="single_blog_post_box">
                    <div class="blog_post_photo">
                        <img src="img/latest_news_post_4.jpg" alt="">
                        <div class="blog_post_date_caption">
                            <span>08 Apr</span>
                        </div>
                    </div>
                    <div class="blog_post_txt">
                        <div class="blog_post_heading">
                            <h2><a href="single-post.html">we know Flipper lives in a world full of wonder flying</a></h2>
                            <p>Posted By : Admin</p>
                        </div>
                        <div class="blog_post_content">
                            <p>The ship set ground on the shore of this uncharted desert isle with Gilligan the Skipper too the millionaire and his wife! Fleeing from the Cylon tyranny the last Battlestar – Galactica - leads a rag-tag fugitive fleet on a lonely quest - a shining planet known as Earth. The ship set ground on the shore of this uncharted desert isle with Gilligan the Skipper too the millionaire.</p>
                            <ul>
                ...
                <div class="single_blog_post_box">
                    <div class="blog_post_photo">
                        <img src="img/latest_news_post_5.jpg" alt="">
                        <div class="blog_post_date_caption">
                            <span>08 Apr</span>
                        </div>
                    </div>
                    <div class="blog_post_txt">
                        <div class="blog_post_heading">
                            <h2><a href="single-post.html">maximum security stockade to the Los Angeles underground</a></h2>
                            <p>Posted By : Admin</p>
                        </div>
                        <div class="blog_post_content">
                            <p>These days are all share them with me oh baby. Got kind of tired packin' and unpackin' - town to town and up and down the dial! So join us here each week my friends you're sure to get a smile from seven stranded castaways here on Gilligans Isle. we might as well say... Would you be mine? Could you be mine? Won't you be my neighbor.</p>
                            <ul>
                                <li><i class="pe-7s-comment"></i>12 Comments</li>

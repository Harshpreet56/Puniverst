...
<!-- Mirrored from html.themeholy.com/edmate/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 06:48:05 GMT -->
...
<head>
    ...
    <!-- file upload -->
    <link rel="stylesheet" href="{{ URL::asset('css/file-upload.css') }}" />
    <!-- file upload -->
    ...
    <!-- jquery Ui -->
    <link rel="stylesheet" href="{{ URL::asset('css/jquery-ui.css.css') }}" />
    <!-- editor quill Ui -->

    <link rel="stylesheet" href="{{ URL::asset('css/editor-quill.css') }}" />
    <!-- apex charts Css -->
    <link rel="stylesheet" href="assets/css/apexcharts.css">
    <!-- calendar Css -->
    <link rel="stylesheet" href="assets/css/calendar.css">
    <!-- jvector map Css -->
    <link rel="stylesheet" href="{{ URL::asset('css/jquery-jvectormap-2.0.5.css') }}" />
...
<!-- Mirrored from html.themeholy.com/edmate/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Feb 2025 06:48:39 GMT -->
